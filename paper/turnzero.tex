...
The ensemble is well-calibrated (adaptive ECE $= 0.012$, Brier $= 0.974$), supports selective prediction (AURC $= 0.890$, E-AURC $= 0.452$), and doubles abstention on out-of-distribution teams (20\%$\to$46\%, AUROC $= 0.80$).
