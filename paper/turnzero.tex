...
\begin{abstract}
TurnZero is a calibrated decision-support system for competitive Pok\'emon VGC, trained on 382K expert replays from best-of-three tournament play.
...
The ensemble also achieves the lowest Brier score (0.974 vs.\ 0.987 popularity), confirming calibration under a proper scoring rule.
